...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "text processing, and vector search that run across all AMPs in parallel. "
        "Do NOT write manual SQL for analytics, ML, data preparation, or search operations — "
        "Teradata has native distributed functions for most of these; always load guidelines and "
        "the relevant syntax topic first. "
        ...
        "(2) call get_syntax_help(topic='guidelines') to see the canonical mapping of common operations "
        "to native Teradata functions, "
        "(3) call get_syntax_help(topic='index') to discover all available topics, "
